...
<?php include('index.php'); ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Tambah Keluarga Yang Tinggal DiRumah Tidak Layak Huni | Puskesos Desa Sekarwangi</h1>
                    <form method="POST" action="18tkeluargayangtinggaldirumahtidaklayakhuni.php"> 
