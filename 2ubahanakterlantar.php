...
<?php include('index.php'); ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Edit Data Anak Terlantar | Puskesos Desa Sekarwangi</h1>
                    <?php
                    include 'koneksi.php';
                    $no = $_GET['no'];
                    $data = mysqli_query($koneksi,"SELECT * FROM anakterlantar WHERE no='$no'");
                    while($d = mysqli_fetch_array($data)){
                        ?>
                        <form method="POST" action="2ubhanakterlantar.php">
