...
<?php include('index.php'); ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Tambah Korban Penyalahgunaan Narkoba | Puskesos Desa Sekarwangi</h1>
                    <form method="POST" action="16tkorbanpenyalahgunaannarkoba.php"> 
