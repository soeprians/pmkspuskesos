...
<?php include('index.php'); ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Tambah Keluarga Bermasalah Sosial Phisiologis | Puskesos Desa Sekarwangi</h1>
                    <form method="POST" action="19tkeluargabermasalahsosialphisiologis.php"> 
