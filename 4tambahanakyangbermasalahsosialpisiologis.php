...
<?php include('index.php'); ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Tambah Data Anak Yang Bermasalah Sosial Pisiologis | Puskesos Desa Sekarwangi</h1>
                    <form method="POST" action="4tanakyangbermasalahsosialpisiologis.php"> 
